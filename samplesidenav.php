    	    ...
    	    <div class="side-bar">
                <ul>
                    ...
                    <!--  <p style="font-family: Verdana,Arial; font-size: 18px; text-align: center;"> <?php  session_start(); echo $_SESSION['fname'],' ', $_SESSION['lname'];?></p>
                        ...
                        <li>
                            <a href="employees.php">Employees <span class="glyphicon glyphicon-user pull-right"></span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="logout.php">Logout <span class="glyphicon glyphicon-off pull-right"></span></a>
                        </li>
